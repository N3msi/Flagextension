class nm_CraftBandanaRag extends RecipeBase
{	
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		...
		nm_BandanaDummy bandanaDummyResult = nm_BandanaDummy.Cast(results[0]);
			if (bandanaDummyResult)
			{
				bandanaDummyResult.SetObjectTexture(2, nmFlagTexture);
