class nm_CraftBandanaRaincoat extends RecipeBase
{	
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player, array<ItemBase> results, float specialty_weight)
	{
		...
		string nmTexOrange = "nm_Flagextension\\flag\\data\\nm_AB_org_co.paa";
		string nmTexGreen = "nm_Flagextension\\flag\\data\\nm_AB_grn_co.paa";
		string nmTexYellow = "nm_Flagextension\\flag\\data\\nm_AB_ylw_co.paa";
		string nmTexPink = "nm_Flagextension\\flag\\data\\nm_AB_pnk_co.paa";
		string nmTexRed = "nm_Flagextension\\flag\\data\\nm_AB_red_co.paa";
		string nmTexBlue = "nm_Flagextension\\flag\\data\\nm_AB_blu_co.paa";
		string nmTexBlack = "nm_Flagextension\\flag\\data\\nm_AB_blk_co.paa";

		// Set string depending on Coat
		string selectedTexture = "";
		if (ingredient0.GetType() == "Raincoat_Orange")
		{
			selectedTexture = nmTexOrange;
		}
		else if (ingredient0.GetType() == "Raincoat_Green")
		{
			selectedTexture = nmTexGreen;
		}
		else if (ingredient0.GetType() == "Raincoat_Yellow")
		{
			selectedTexture = nmTexYellow;
		}
		else if (ingredient0.GetType() == "Raincoat_Pink")
		{
			selectedTexture = nmTexPink;
		}
		else if (ingredient0.GetType() == "Raincoat_Red")
		{
			selectedTexture = nmTexRed;
		}
		else if (ingredient0.GetType() == "Raincoat_Blue")
		{
			selectedTexture = nmTexBlue;
		}
		else if (ingredient0.GetType() == "Raincoat_Black")
		{
			selectedTexture = nmTexBlack;
		}
		...
		for (int i = 0; i < results.Count(); i++)
		{
			...
			if (bandanaDummyResult)
			{
				...
				bandanaDummyResult.SetnmFlagTexture(selectedTexture);
			}
		}
	}
